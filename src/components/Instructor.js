  ...
  return (
    <section className="px-[15px] mx-0 sm:mx-[9.6px] pb-[123px] pt-[156px]">
      <div className='flex flex-col lg:flex-row justify-center lg:justify-start items-center relative lg:mt-[151px] lg:mb-[129px]'>
        <div className='z-20 relative flex flex-col items-center lg:items-start text-center lg:text-start'>
          ...
          <div className='mt-[38px] max-w-[603px] text-center lg:text-start'>
            <p className='text-[#C1C1C1] text-sm sm:text-base font-normal'>
              ...
              <br />
              <br />
              Олександр Георгіца - власник мотошколи RSMOTO та багаторазовий чемпіон 
              України з мотоперегонів. Має більше 15 років в управлінні мотоциклом, 
              яким він ділиться зі своїми учнями.
            </p>
          </div>
        </div>

        <div className='relative lg:absolute lg:left-[30%] mt-14 lg:mt-0 after:content-[""] after:absolute after:w-full after:h-[60%] after:bg-gradient-moto after:bottom-[0] after:left-0 '>
